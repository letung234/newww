...
var medias_service_1 = require("~/services/medias.service");
...
exports.upload = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, medias_service_1["default"].uploadImage(req)];
            case 1:
                result = _a.sent();
                console.log(result);
...
exports.deleteImage = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                console.log(id);
                return [4 /*yield*/, medias_service_1["default"].deleteImage(id)];
            case 1:
                result = _a.sent();
