...
exports.GetEditController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, database_service_1["default"].Role.findOne({ _id: new mongodb_1.ObjectId(id), deleted: false })];
            case 1:
                record = _a.sent();
...
// [GET] /permission
exports.GetPermissionController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var records;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, database_service_1["default"].Role.find({ deleted: false }).toArray()];
